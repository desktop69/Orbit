...
import { Bar, Column, Area, DualAxes, Line } from '@ant-design/charts';
import { buildDrillTree, convertDrillTreeToCrossTree, buildRecordMatrix, CrossTable } from 'ali-react-table/pivot';
  ...
  if (inverted) {
    ...
    return /*#__PURE__*/React.createElement(Bar, Object.assign({
      ...
      errorTemplate: function errorTemplate() {
        return /*#__PURE__*/React.createElement(ErrorTemplate, null);
      }
    }, props));
  } else {
    return /*#__PURE__*/React.createElement(Column, Object.assign({}, generateConfig(meta, data), {
      renderer: "svg",
      errorTemplate: function errorTemplate() {
        return /*#__PURE__*/React.createElement(ErrorTemplate, null);
      }
...
var CRLine = function CRLine(_ref8) {
  ...
  if (withArea) {
    return /*#__PURE__*/React.createElement(Area, Object.assign({}, config, {
      renderer: "svg",
      errorTemplate: function errorTemplate() {
        return /*#__PURE__*/React.createElement(ErrorTemplate, null);
      }
  ...
  if (Array.isArray(config.yField)) {
    return /*#__PURE__*/React.createElement(DualAxes, Object.assign({}, config, {
      renderer: "svg",
      errorTemplate: function errorTemplate() {
        return /*#__PURE__*/React.createElement(ErrorTemplate, null);
      }
...
var CRPivotTable = function CRPivotTable(_ref) {
  ...
  var leftDrillTree = buildDrillTree(data, leftCodes, {
  ...
  var topDrillTree = buildDrillTree(data, topCodes, {
    includeTopWrapper: true,
  ...
  var _convertDrillTreeToCr3 = convertDrillTreeToCrossTree(topDrillTree, {
    // @ts-expect-error => 可以传入 align 字段
  ...
  }, /*#__PURE__*/React.createElement(CrossTable, Object.assign({
...
export { CRColumn as Column, CRLine as Line, CRPivotTable as PivotTable };
