...
var DagreLayout = /** @class */ (function (_super) {
    ...
    DagreLayout.prototype.execute = function () {
        ...
        // 变形为辐射
        if (radial) {
            var _a = this, focusNode = _a.focusNode, ranksep = _a.ranksep, getRadialPos_1 = _a.getRadialPos;
            var focusId = (0, util_1.isString)(focusNode) ? focusNode : focusNode === null || focusNode === void 0 ? void 0 : focusNode.id;
            var focusLayer_1 = focusId ? g.node(focusId)._rank : 0;
            var layers_1 = [];
            ...
            g.edges().forEach(function (edge) {
                ...
                if ((self.edgeLabelSpace) && self.controlPoints && edges[i].type !== "loop") {
                    ...
                    var controlPoints = coord.points.slice(1, coord.points.length - 1);
                    var newControlPoints_1 = [];
                    var sourceOtherDimValue_1 = (_a = g.node(edge.v)) === null || _a === void 0 ? void 0 : _a[otherDim_1];
                    var otherDimDist_1 = sourceOtherDimValue_1 - ((_b = g.node(edge.w)) === null || _b === void 0 ? void 0 : _b[otherDim_1]);
