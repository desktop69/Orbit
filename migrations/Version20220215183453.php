 ...
 */
final class Version20220215183453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE id_client id_client INT NOT NULL, CHANGE is_active is_active TINYINT(1) NOT NULL, CHANGE birthdate birthdate DATETIME NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
    }
